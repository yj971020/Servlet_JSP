...
<body class="is-preload">
	...
	<c:if test="${!empty Member and !empty Member.email }">
		...
		<a  class="button scrolly" href="<%=request.getContextPath() %>review1.html">마이페이지</a>	
			...
			<section>
				...
				<div class="content">
					<div class="inner">
						...
						<ul class="actions">
							<li><a href="serviceoffice_IPAS_02.html" class="button">지점 소개</a></li>
						</ul>
					</div>
				</div>
			</section>
			<section>
				...
				<div class="content">
					<div class="inner">
						...
						<ul class="actions">
							<li><a href="serviceoffice_IPAS_01.html" class="button">지점 소개</a></li>
						</ul>
					</div>
				</div>
			</section>
			<section>
				...
				<div class="content">
					<div class="inner">
						...
						<ul class="actions">
							<li><a href="serviceoffice_IPAS_03.html" class="button">지점 소개</a></li>
						</ul>
					</div>
				</div>
			</section>
